...
LOCATION 's3a://tech-summit-data-bucket/data/input/original_access_logs';
...
CREATE EXTERNAL TABLE tokenized_access_logs (
    ...
    user_agent STRING)
stored as parquet
LOCATION 's3a://tech-summit-data-bucket/data/output/${YOURNAMEHERE}/tokenized_access_logs';
